...
public class MyFlowlayout extends ViewGroup {
    ...
    public MyFlowlayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        vertivalSpace = ta.getDimension(R.styleable.MyFlowlayout_vertivalSpace, dp2px(4));
        pileWidth = ta.getDimension(R.styleable.MyFlowlayout_pileWidth, dp2px(10));
        ta.recycle();
    }
